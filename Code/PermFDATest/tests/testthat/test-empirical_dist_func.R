test_that(paste0("Fourier Version of Empirical Distribution Function works for ",
  ...
  test_coefs_1 <- t(matrix(data = c(c(5, rep(0, times = 13), 1),
  ...
  dist_1 <- empirical_dist_func_fourier(sample = test_sample_1, func = comparison_function,
                                      domain = c(0,2*pi), n_fourier_basis = 15)

  # add one function that where the difference has zeroes
  test_coefs_2 <- t(matrix(data = c(c(5, rep(0, times = 13), 1),
                                    c(4, rep(0, times = 13), 1),
  ...
  dist_2 <- empirical_dist_func_fourier(sample = test_sample_2, func = comparison_function,
                                        domain = c(0,2*pi), n_fourier_basis = 15)
